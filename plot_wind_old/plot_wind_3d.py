...
from plot_wind_old.wind_visualization_methods import WindVisualizer
...
def process_combination(args):
    ...
    if 'streamline' in plot_types:
        visualizer.streamline_plot(f'picture/{base_name}_streamline.png', n_layers)
